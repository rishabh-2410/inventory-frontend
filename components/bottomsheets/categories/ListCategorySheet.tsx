    ...
    []
      ...
      return (
        ...
        >
          ...
          >
            <View className="mb-5">
              <Text className="text-[22px] font-bold text-[#171a21]">Select Category</Text>
            ...
            <FlatList
              ...
              renderItem={({ item} : {item: Category}) => {
                return (
                  ...
                  >
                    ...
                    <Text className="mt-1 text-[13px] text-[#7a8596]">{item.description}</Text>
                  </Pressable>
                )
              }}
              ...
              ListEmptyComponent={
                <View className="rounded-2xl border border-[#e6ebf1] bg-[#f8fafc] px-4 py-6">
                  <Text className="text-center text-[15px] text-[#7a8596]">No categories found</Text>
                </View>
              }
