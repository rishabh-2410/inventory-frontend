...
export default function CategoryScreen() {
  ...
  if (isError) {
    return <View>
      <Text className="font-inter-regular text-[15px] text-[#7a8596]">Error loading categories</Text>
    </View>;
  }
              ...
              <View>
                <View className="mx-[-24px] mb-6 border-b border-[#e5e7eb] bg-white px-6 py-5">
                  <View className="flex-row items-center justify-between">
                    <Text className="text-[18px] font-inter-bold text-[#171a21]">Categories</Text>
                ...
                >
                  <Text className="text-[18px] font-inter-semibold text-white">+ Add New Category</Text>
                </Pressable>
              </View>
            }
            ListEmptyComponent={
