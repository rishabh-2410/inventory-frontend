...
export default function WarehouseScreen() {
  ...
  if (isError) {
    return <View>
      <Text>Error loading warehouses</Text>
    </View>;
  }
              ...
              <View>
                <View className="mx-[-24px] mb-6 border-b border-[#e5e7eb] bg-white px-6 py-5">
                  <View className="flex-row items-center justify-between">
                    <Text className="text-[18px] font-bold text-[#171a21]">Warehouses</Text>
                ...
                >
                  <Text className="text-[18px] font-semibold text-white">+ Add New Warehouse</Text>
                </Pressable>
              </View>
            }
            ListEmptyComponent={
